...
PointIntersector::PointIntersector(): osgUtil::LineSegmentIntersector(MODEL, 0.0, 0.0), _pick_bias(2.0f)
{
    
}

PointIntersector::PointIntersector(const osg::Vec3 &start, const osg::Vec3 &end): osgUtil::LineSegmentIntersector(start, end), _pick_bias(2.0f){
    
}

PointIntersector::PointIntersector(CoordinateFrame cf, double x, double y): osgUtil::LineSegmentIntersector(cf, x, y), _pick_bias(2.0f){
