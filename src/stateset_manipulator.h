#ifndef STATESET_MANIPULATOR_H_
#define STATESET_MANIPULATOR_H_
...
public:
    ...
    bool getSmoothShadeEnabled() const {return _smooth_shade;};
    void setKeyEventToggleSmoothShade(int key) { _keyEventToggleSmoothShade = key; }
    int getKeyEventToggleSmoothShade() const { return _keyEventToggleSmoothShade; }
