...
namespace OSGUtility
{
	...
	osg::Geode* drawCylinders(const osg::Vec3Array* bases, const osg::Vec3Array* tops, const std::vector<double>& radii, const osg::Vec4Array* colors, int subdivide_level)
	{
		osg::Geode* geode = new osg::Geode();
	...
	osg::Group* drawArrow(const osg::Vec3& base, const osg::Vec3& top, double radius, const osg::Vec4& color)
	{
		...
		osg::Vec3 offset = top-base;
		group->addChild(OSGUtility::drawCylinder(base, base+offset*0.8, radius, color));
		group->addChild(OSGUtility::drawCone(base+offset*0.8, top, radius*1.5, color));
    ...
    static void triangulateSphere(int subdivide_level, std::vector<int>& triangles, osg::Vec3Array* vertices, osg::Vec3Array* normals)
    {
        ...
        triangles.push_back(0); triangles.push_back(5); triangles.push_back(4);
        triangles.push_back(0); triangles.push_back(1); triangles.push_back(5);
        
        triangles.push_back(1); triangles.push_back(2); triangles.push_back(7);
        triangles.push_back(2); triangles.push_back(3); triangles.push_back(8);
        triangles.push_back(3); triangles.push_back(4); triangles.push_back(9);
        triangles.push_back(4); triangles.push_back(5); triangles.push_back(10);
        triangles.push_back(5); triangles.push_back(1); triangles.push_back(6);
        
        triangles.push_back(1); triangles.push_back(7); triangles.push_back(6);
        triangles.push_back(2); triangles.push_back(8); triangles.push_back(7);
        triangles.push_back(3); triangles.push_back(9); triangles.push_back(8);
        triangles.push_back(4); triangles.push_back(10); triangles.push_back(9);
        triangles.push_back(5); triangles.push_back(6); triangles.push_back(10);
        
        triangles.push_back(6); triangles.push_back(7); triangles.push_back(11);
        triangles.push_back(7); triangles.push_back(8); triangles.push_back(11);
        triangles.push_back(8); triangles.push_back(9); triangles.push_back(11);
        triangles.push_back(9); triangles.push_back(10); triangles.push_back(11);
        triangles.push_back(10); triangles.push_back(6); triangles.push_back(11);
        ...
        while (subdivide_level --)
        {
            ...
            for (size_t i = 0, i_end = triangles.size()/3; i < i_end; ++ i)
            {
                ...
                subdivided.push_back(triangles[3*i+0]); subdivided.push_back(v+0); subdivided.push_back(v+2);
                subdivided.push_back(v+0); subdivided.push_back(triangles[3*i+1]); subdivided.push_back(v+1);
                subdivided.push_back(v+2); subdivided.push_back(v+1); subdivided.push_back(triangles[3*i+2]);
                subdivided.push_back(v+0); subdivided.push_back(v+1); subdivided.push_back(v+2);
            }
    ...
    osg::Geode* drawTetrahedron(const osg::Vec3& center, double radius, const osg::Vec4& color)
    {
        ...
        normals->at(0) = osg::Vec3(+offset, -offset, -offset); normals->at(0).normalize();
        normals->at(1) = osg::Vec3(-offset, -offset, +offset); normals->at(1).normalize();
        normals->at(2) = osg::Vec3(-offset, +offset, -offset); normals->at(2).normalize();
        normals->at(3) = osg::Vec3(+offset, +offset, +offset); normals->at(3).normalize();
