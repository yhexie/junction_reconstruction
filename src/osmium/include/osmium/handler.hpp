...
namespace Osmium {
    ...
    namespace Handler {
        ...
        public:
            ...
            void node(const boost::shared_ptr<Osmium::OSM::Node const>&) const {
            }
            ...
            void way(const boost::shared_ptr<Osmium::OSM::Way const>&) const {
            }
            ...
            void relation(const boost::shared_ptr<Osmium::OSM::Relation const>&) const {
            }

            void after_relations() const {
            }

            void area(const boost::shared_ptr<Osmium::OSM::Area const>&) const {
            }
        ...
        public:
            ...
            void node(const boost::shared_ptr<Osmium::OSM::Node>& node) const {
            ...
            void way(const boost::shared_ptr<Osmium::OSM::Way>& way) const {
            ...
            void relation(const boost::shared_ptr<Osmium::OSM::Relation>& relation) const {
            ...
            void area(const boost::shared_ptr<Osmium::OSM::Area>& area) const {
